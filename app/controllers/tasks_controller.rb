class TasksController < ApplicationController
  ...
  # GET /tasks.json
  def index
    # assosiated that current user with all the tasks he has (related to the state)
  ...
  # POST /tasks.json
  def create
    # every time a task is made it will assosiate it with a current user
  ...
  def change
    ...
    # after task update is complete, setting format of resulting file
